...
def default_compute_score(
    ...
    **kwargs,
    ...
    elif data_source == "kk_logic" or data_source.startswith("kk_ppl"):
        from . import kk_logic

        res = kk_logic.compute_score(solution_str, ground_truth)
    elif data_source in ["math_dapo", "math", "math_dapo_reasoning"] or data_source.startswith("aime") or data_source.startswith("polaris"):
        from . import math_verify
        res = math_verify.compute_score(solution_str, ground_truth)
    elif data_source in [
        "numina_aops_forum",
