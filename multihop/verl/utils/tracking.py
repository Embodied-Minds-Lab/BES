...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            wandb_run_id = config["trainer"].get("wandb_run_id", None) if config else None
            if wandb_run_id:
                # Resume an existing W&B run so step axis continues seamlessly across SLURM relaunches.
